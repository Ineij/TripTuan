  ...
  hk: [
    {
      ...
      items: [
        { period: '出发', cat: '交通', name: '高铁·深圳北 → 香港西九龙', rating: 4.8, duration: '14 分钟', price: '¥75 / 人', queue: '低', photoSeed: 'hk-train' },
        { period: '上午', cat: '景点', name: '尖沙咀海港城', rating: 4.6, duration: '2-3 小时', queue: '低', photoSeed: 'tst-harbour-city' },
        { period: '中午', cat: '美食', name: '港式茶餐厅（澳洲牛奶公司）', rating: 4.6, duration: '40 分钟', price: '人均 ¥80', queue: '中', photoSeed: 'aussie-dairy' },
        { period: '下午', cat: '景点', name: '维多利亚港', rating: 4.7, duration: '2-3 小时', queue: '低', photoSeed: 'victoria-harbour' },
        { period: '晚餐', cat: '美食', name: '镛记烧鹅', rating: 4.8, duration: '60 分钟', price: '人均 ¥260', queue: '高', photoSeed: 'yung-kee-goose' },
        { period: '晚上', cat: '景点', name: '星光大道', rating: 4.0, duration: '2 小时', queue: '低', photoSeed: 'avenue-of-stars' },
        { period: '晚上', cat: '酒店', name: '香港君怡酒店', rating: 4.8, duration: '入住 1 晚', price: '¥1167 起 / 晚', hotelTier: '高档型', note: '今晚睡这里：尖沙咀核心地段，步行回酒店', photoSeed: 'hk-hotel-bp' },
      ],
    },
    {
      label: 'DAY 2', title: '山顶与返程',
      items: [
        { period: '上午', cat: '景点', name: '太平山顶', rating: 4.8, duration: '2-3 小时', price: '¥99', queue: '中', photoSeed: 'victoria-peak' },
        { period: '中午', cat: '美食', name: '兰芳园中环创办店', rating: 4.5, duration: '45 分钟', price: '人均 ¥65', queue: '低', photoSeed: 'aussie-dairy' },
        { period: '返程', cat: '交通', name: '高铁·香港西九龙 → 深圳北', rating: 4.8, duration: '14 分钟', price: '¥75 / 人', queue: '低', photoSeed: 'hk-train' },
      ],
    },
  ],
  bj: [
    {
      ...
      items: [
        { period: '出发', cat: '交通', name: '高铁·石家庄 → 北京南', rating: 4.8, duration: '1 小时 12 分钟', price: '¥128 / 人', queue: '低', photoSeed: 'bj-train' },
        { period: '上午', cat: '景点', name: '天安门广场', rating: 4.9, duration: '1.5 小时', queue: '中', photoSeed: 'bj-tiananmen' },
        { period: '上午', cat: '景点', name: '故宫博物院', rating: 4.8, duration: '3 小时', price: '¥60', queue: '中', photoSeed: 'bj-forbidden-city' },
        { period: '中午', cat: '美食', name: '四季民福烤鸭', rating: 4.7, duration: '70 分钟', price: '人均 ¥160', queue: '中', photoSeed: 'bj-roast-duck' },
        { period: '下午', cat: '景点', name: '王府井步行街', rating: 4.5, duration: '2 小时', queue: '低', photoSeed: 'bj-wangfujing' },
        { period: '晚上', cat: '酒店', name: '北京王府井希尔顿', rating: 4.8, duration: '入住 1 晚', price: '¥1280 起 / 晚', hotelTier: '豪华型', note: '今晚睡这里：离地铁近，第二天去颐和园更顺', photoSeed: 'bj-hotel-hilton' },
      ],
    },
    {
      label: 'DAY 2', title: '慢节奏返程',
      items: [
        { period: '上午', cat: '景点', name: '颐和园泛舟', rating: 4.7, duration: '2 小时', price: '¥30', queue: '低', photoSeed: 'bj-summer-palace' },
        { period: '中午', cat: '美食', name: '护国寺小吃', rating: 4.5, duration: '50 分钟', price: '人均 ¥45', queue: '低', photoSeed: 'bj-roast-duck' },
        { period: '下午', cat: '景点', name: '什刹海', rating: 4.4, duration: '1.5 小时', queue: '低', photoSeed: 'bj-shichahai' },
        { period: '返程', cat: '交通', name: '高铁·北京南 → 石家庄', rating: 4.8, duration: '1 小时 14 分钟', price: '¥128 / 人', queue: '低', photoSeed: 'bj-train' },
      ],
    },
  ],
};
...
export default function Step5_Preview() {
  ...
  const sceneTitle  = scene === 'hk' ? '香港周末漫游' : '北京家庭文化游';
  const sceneRoute  = scene === 'hk' ? '深圳 → 香港 · 2 天 1 夜' : '河北 → 北京 · 2 天 1 夜';
  const sceneTotalKm = scene === 'hk' ? '8.4' : '12.6';
  ...
  return (
    <MobileFrame>
      ...
      <div className="scroll-area" style={{ padding: '14px 14px 140px' }}>
        ...
        >
          <div style={{ fontSize: 22, fontWeight: 800 }}>{sceneTitle}</div>
          <div style={{ fontSize: 12.5, opacity: 0.9, marginTop: 4 }}>{sceneRoute}</div>
          <div
            style={{
              marginTop: 14,
...
function PreviewCard({ item, last }: { item: Item; last?: boolean }) {
  ...
  return (
    ...
    >
      <Photo seed={item.photoSeed} width={50} height={50} radius={8} style={{ flexShrink: 0 }} />
